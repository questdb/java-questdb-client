...
```groovy
implementation 'org.questdb:client:1.0.0-SNAPSHOT'
```

Replace `1.0.0-SNAPSHOT` with the latest version from [Maven Central](https://central.sonatype.com/artifact/org.questdb/client).
