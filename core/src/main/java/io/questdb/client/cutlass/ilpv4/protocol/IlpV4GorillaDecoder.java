 ...
 */
public class IlpV4GorillaDecoder {
    ...
    private final IlpV4BitReader bitReader;
     ...
     */
    public IlpV4GorillaDecoder() {
        this.bitReader = new IlpV4BitReader();
    }
     ...
     */
    public IlpV4GorillaDecoder(IlpV4BitReader bitReader) {
