...
import io.questdb.client.cutlass.line.array.ArrayDataAppender;
import io.questdb.client.cutlass.line.array.ArrayShapeAppender;
import io.questdb.client.cutlass.line.array.DoubleArray;
import io.questdb.client.cutlass.line.array.FlattenArrayUtils;
...
public class LineTcpSenderV2 extends AbstractLineTcpSender implements ArrayBufferAppender {
    ...
    public Sender doubleArray(CharSequence name, DoubleArray array) {
        ...
        writeFieldName(name)
                .putAsciiInternal('=')
                .put(EntityTypes.ARRAY) // ARRAY binary format
