...
package io.questdb.client.cutlass.line.tcp;
...
public final class PlainTcpLineChannel implements LineChannel {
    private static final Logger LOG = LoggerFactory.getLogger(PlainTcpLineChannel.class);
    ...
    private void configureBuffers(NetworkFacade nf, int sndBufferSize) {
        ...
        LOG.debug("Send buffer size change from {} to {}", orgSndBufSz, newSndBufSz);
    }
}