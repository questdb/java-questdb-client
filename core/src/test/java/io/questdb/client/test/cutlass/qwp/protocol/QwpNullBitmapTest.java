...
import io.questdb.client.cutlass.qwp.protocol.QwpNullBitmap;
...
public class QwpNullBitmapTest {
    ...
    public void testAllNulls() throws Exception {
        assertMemoryLeak(() -> {
            ...
            try {
                ...
                Unsafe.free(address, size, MemoryTag.NATIVE_ILP_RSS);
            }
        });
    }

    @Test
    public void testAllNullsPartialByte() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testBitmapBitOrder() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testBitmapByteAlignment() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testBitmapSizeCalculation() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testBitmapWithPartialLastByte() throws Exception {
        assertMemoryLeak(() -> {
    ...
    @Test
    public void testByteArrayOperations() throws Exception {
        assertMemoryLeak(() -> {
            int rowCount = 16;
            int size = QwpNullBitmap.sizeInBytes(rowCount);
