...
public class QwpVarintTest {
    ...
    public void testDecodeIncompleteVarint() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("incomplete varint"));
        }
    }
    ...
    public void testDecodeOverflow() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("varint overflow"));
        }
    }
    ...
    @Test
    public void testDecodeResultReuse() {
        byte[] buf = new byte[10];
        QwpVarint.DecodeResult result = new QwpVarint.DecodeResult();
    ...
    @Test
    public void testEncodeDecode127() {
    ...
    @Test
    public void testEncodeDecode128() {
    ...
    @Test
    public void testEncodeDecode16383() {
    ...
    @Test
    public void testEncodeDecode16384() {
    ...
    @Test
    public void testEncodeLargeValues() {
        byte[] buf = new byte[10];
