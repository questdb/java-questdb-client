...
/**
 * Verifies that {@link QwpWebSocketSender#reset()} discards all pending state,
 * not just the current table buffer.
 */
public class QwpWebSocketSenderResetTest extends AbstractTest {
