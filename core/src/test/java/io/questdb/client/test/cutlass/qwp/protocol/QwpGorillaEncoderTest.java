...
public class QwpGorillaEncoderTest {
    ...
    @Test
    public void testCalculateEncodedSizeConstantDelta() {
    ...
    @Test
    public void testCalculateEncodedSizeEmpty() {
        Assert.assertEquals(0, QwpGorillaEncoder.calculateEncodedSize(0, 0));
    }

    @Test
    public void testCalculateEncodedSizeIdenticalDeltas() {
    ...
    @Test
    public void testCalculateEncodedSizeOneTimestamp() {
        long[] ts = {1000L};
        long src = putTimestamps(ts);
        try {
    ...
    @Test
    public void testCalculateEncodedSizeSmallDoD() {
    ...
    @Test
    public void testCalculateEncodedSizeTwoTimestamps() {
        long[] ts = {1000L, 2000L};
        long src = putTimestamps(ts);
        try {
    ...
    @Test
    public void testCanUseGorillaConstantDelta() {
        long[] timestamps = new long[100];
        for (int i = 0; i < timestamps.length; i++) {
            timestamps[i] = 1_000_000_000L + i * 1000L;
        }
    ...
    @Test
    public void testCanUseGorillaEmpty() {
        Assert.assertTrue(QwpGorillaEncoder.canUseGorilla(0, 0));
    }

    @Test
    public void testCanUseGorillaLargeDoDOutOfRange() {
    ...
    @Test
    public void testCanUseGorillaNegativeLargeDoDOutOfRange() {
    ...
    @Test
    public void testCanUseGorillaOneTimestamp() {
        long[] ts = {1000L};
        long src = putTimestamps(ts);
        try {
    ...
    @Test
    public void testCanUseGorillaTwoTimestamps() {
        long[] ts = {1000L, 2000L};
        long src = putTimestamps(ts);
        try {
    ...
    @Test
    public void testCanUseGorillaVaryingDelta() {
        long[] timestamps = {
                1_000_000_000L,
    ...
    @Test
    public void testEncodeDecodeBucketBoundaries() {
    ...
    @Test
    public void testEncodeTimestampsEmpty() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
        long dst = Unsafe.malloc(64, MemoryTag.NATIVE_ILP_RSS);
        try {
    ...
    @Test
    public void testEncodeTimestampsOneTimestamp() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
    ...
    @Test
    public void testEncodeTimestampsRoundTripAllBuckets() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
        QwpBitReader reader = new QwpBitReader();
    ...
    @Test
    public void testEncodeTimestampsRoundTripConstantDelta() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
        QwpBitReader reader = new QwpBitReader();
    ...
    @Test
    public void testEncodeTimestampsRoundTripLargeDataset() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
        QwpBitReader reader = new QwpBitReader();
    ...
    @Test
    public void testEncodeTimestampsRoundTripNegativeDoD() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
        QwpBitReader reader = new QwpBitReader();
    ...
    @Test
    public void testEncodeTimestampsRoundTripVaryingDelta() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
        QwpBitReader reader = new QwpBitReader();
    ...
    @Test
    public void testEncodeTimestampsTwoTimestamps() {
        QwpGorillaEncoder encoder = new QwpGorillaEncoder();
     ...
     */
    private static long decodeDoD(QwpBitReader reader) {
